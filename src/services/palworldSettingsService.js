...
const SETTING_GROUPS = [
    ...
    },
    {
        name: 'PvP & Combat',
        fields: [
            { key: 'bIsPvP', label: 'PvP Enabled', format: yesNo },
            { key: 'bEnablePlayerToPlayerDamage', label: 'Player-to-Player Damage', format: yesNo },
            ...
            { key: 'PlayerDamageRateDefense', label: 'Player Damage Taken', format: (v) => `${v}x` },
            { key: 'DeathPenalty', label: 'Death Penalty', format: (v) => v },
            { key: 'bHardcore', label: 'Hardcore Mode', format: yesNo },
        ],
    },
    {
        name: 'Server',
        fields: [
            { key: 'ServerName', label: 'Server Name', format: (v) => v },
